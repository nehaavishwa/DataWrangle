...
def get_from_file(kind, period):
    filename = r"/home/nehaavishwa/PycharmProjects/DataWrangle/Files/popular-{0}-{1}.json".format(kind, period)
...
def article_overview(kind, period):
    ...
    #print(data)
    for trend in data:
        titles1 = {trend['section']: trend['title']}
        titles.append(titles1)
        url1 = trend['media']
        for u in url1:
            for format in u['media-metadata']:
                if format['format'] == 'Standard Thumbnail':
...
def query_site(url, target, offset):
    ...
    if API_KEY["popular"] == "ae2207a6ceb4e0c56168b434a6c92c39:5:7353109" or API_KEY["article"] == "276c684927d10da6b6b38cf9d2130767:3:73531097":
